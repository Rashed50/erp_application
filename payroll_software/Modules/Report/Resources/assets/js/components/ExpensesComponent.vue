<template>
    <div class="card" style="padding:0px; margin: 0px;">
        <!-- <div class="card-header"> -->
            <h4 class="text-center fw-bold" style="color: blue">Expense Report</h4>
        <!-- </div> -->
        <div class="card-body">
            <form>
                <div class="row">
    ...
    methods: {
        ...
        downloadReport() {
            if (this.form.report_type === 'PDF') {
                const url = `/admin/report/expense-details-report?` + new URLSearchParams(this.form).toString();
        ...
        async generatePdfInNewTab() {
            try {
                const response = await axios.post("/admin/report/expense-details-report", this.form);
                if (response.data.success) {
