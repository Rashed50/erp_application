    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="title_left__part">
                <p> <strong> Reporting : <span>{{$from}}</span> <span>To {{$to}}</span></strong></p>
            </div>
            <!-- title -->
        ...
        <h3 style="text-align:center"> Ticket Details Report</h3><br>
        <!-- table part -->
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> <span>Ticket Date</span></th>
                        {{-- <th> <span>Ticket Number</span> </th> --}}
                        <th> <span>Ticket Type </span> </th>
                        <th> <span>Reference By</th>
                        <th> <span>Total Price</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__amount">{{ $item['Total_Price'] }}</td>
                    </tr>
                    @endforeach
                    <tr>
                        <td class="" colspan="7"> <strong>Total</strong> </td>
                        <td class="td__total_amount"> <strong>{{ $totalAmount }}</strong> </td>
                    </tr>
                </tbody>
            </table>
        </section>
