...
<body>
    ...
    <div class="page-container">
        ...
        <main>
            <h4 style="text-align:center; font-weight: bold;">SUB-CONTRACTORS SALARY SUMMARY MONTH OF {{strtoupper(date("F", mktime(0, 0, 0, $month, 10))) }} {{ $year }}</h4>
            ...
            <tbody>
                    <tr>
                        ...
                        <th>{{ strtoupper($sp->spons_name) }}</th>
                        @endforeach
                        <th>TOTAL SALARY</th>
                    </tr>
                    @php
                    ...
                    <tr>
                        ...
                        <td class="td__project">{{strtoupper($ar->proj_name) }}</td>
                    ...
                    <tr>
                        ...
                        @foreach($sponsors_base_total_amount as $sp)
                            <td class="td__total"> {{ $sp <= 0 ? '-':  number_format( $sp , 0, '.', ',') }} </td>
                        @endforeach
                        <td class="td__total">{{ $grand_total_amount <= 0 ? '-':  number_format( $grand_total_amount , 0, '.', ',') }}  </td>
