    ...
    */
    ...
    public function map($item): array
    {
      //  dd($item);
        ...
        $arecord[8] =  $basic_salary;
        $arecord[9] =  $item->house_rent > 0 ? $item->house_rent : '-';
        $arecord[10] =  $other_allowance > 0 ? $other_allowance : '-';
        $arecord[11] = $total_deduct_amount > 0 ? $total_deduct_amount:'-' ;
        $arecord[12] = $basic_salary + $item->house_rent + $other_allowance - $total_deduct_amount ;
