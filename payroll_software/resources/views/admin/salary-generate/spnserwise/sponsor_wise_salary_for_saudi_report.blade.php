    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p><strong class="td__red__color"> {{ $report_title[0] }} </strong> </p>
                <p>  {!! nl2br($report_title[1]) !!}      </p>   
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__total">Total Salary <br> {{ $totalSalaryAmount + $totalSaudiTax + $totalIqamaRenewal +$totalOtherAdvance +$totalContribution }}</td>
