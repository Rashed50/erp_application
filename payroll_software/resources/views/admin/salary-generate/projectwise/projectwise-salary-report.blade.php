...
<body>
    <!-- Angled Watermark -->
    <div class="watermark">   {{ strtoupper($company->comp_name_en ?? 'CONFIDENTIAL') }}</div>
    ...
    <div class="main__wrap">
        ...
        <section class="table__part">
            <table  id="employeeinfo">
                <thead>
                    <tr>
                        <th colspan = "13" style="text-align: center;" >{{ $monthName }}, {{$salaryYear}}, Project: {{ $project}}, {{ $employeeType}} </th>
                    </tr>
                    <tr>
                        <th>SL<br>No </th>
                        <th> Emp. <br> ID </th>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__project"> {{ Str::limit($salary->project->proj_name,40) }}<br>
                           <div class="box__signature">
                                @if($salary->Status == 0)  {{-- salary unpaid    --}}
