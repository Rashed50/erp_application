...
<head>
    ...
    * {
    ...
    /* Angled watermark - This creates the rotated watermark */
    .watermark {
        position: fixed;
        top: 50%;
        left: 50%;
    ...
    /* For print - angled watermark appears on every page */
    @media print {
        .watermark {
            position: fixed;
            top: 50%;
...
<body>
    <div class="watermark-container">
        ...
        <div class="main__wrap">
                ...
                <table id="employeeinfo">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="td__total">ID+P.Paid<br>{{ round($totalIqamaRenewal) }} <br>{{  round($totalPartialAmnt) }}  </td>
            ...
            <section>
                <div class="officer-signature" style="padding-top: 80px; display: flex; justify-content:space-between; text-align: center;">
        ...
        <!-- Footer Section -->
        <div class="footer">
            <p>Online System Generated Statement Authorized by Accounts Department</p>
        </div>
    </div>
