...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <br> <br>  <h3 style="text-align:center; color:red">Monthly Salary Employee Summary Statement </h3> <br>
            ...
            <table id="employeeinfo">
                <tbody>
                    <tr>
                        ...
                        <th>Year</th>
                        <th>Month</th>
                        <th> Basic Salary Total Emp.</th>
                        <th> Hourly Total Emp.</th>  
                    ...
                    <tr>
                        ...
                        <td class="amount__td">{{$salary['total_basic_emp']}}</td>
                        <td class="amount__td">{{ $salary['total_hourly_emp']}}</td>  
                        <td class="amount__td">{{$salary['total_emp']}}</td>                      
                        <td class="amount__td">{{$salary['salary_paid_total_emp']}}</td>
                        <td class="amount__td">{{$salary['salary_unpaid_total_emp']}}</td>                   
                    </tr>
                    @endforeach 
