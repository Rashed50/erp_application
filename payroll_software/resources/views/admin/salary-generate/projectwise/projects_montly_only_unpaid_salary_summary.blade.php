...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <h3 style="text-align:center; color:red">Unpaid Salary Summary </h3> <br>
            ...
            <table id="employeeinfo">
                <tbody>
                    ...
                    <tr>
                        ...
                        <th>Basic Total/Total Emp.</th>
                        <th>Hourly Total/Total Emp.</th>
                        <th>Total Amount </th>
                    </tr>
                    ...
                    <tr>
                        ...
                        {{-- <td class="td_amount">{{ number_format(( $ar->basic_emp + $ar->hourly_emp) , 2, '.', ',') }} </td>
                        <td class="td_amount"> {{ number_format(($ar->basic_hours+$ar->hourly_hours) , 2, '.', ',') }} </td>
                        <td class="td_amount">{{number_format(($ar->all_incl_total_basic_salary+$ar->all_incl_total_hourly_salary) , 2, '.', ',')}} </td> --}}


                        <td class="td_amount">{{number_format(( $ar->basic_unpaid_amount),2, '.', ',')}} <br>{{  $ar->basic_unpaid_emp }} </td>
                        <td class="td_amount">{{number_format(($ar->hourly_unpaid_amount) ,2, '.', ',')}} <br>{{$ar->hourly_unpaid_emp }} </td>
                        <td class="td_amount">{{number_format(( $ar->basic_unpaid_amount + $ar->hourly_unpaid_amount) , 2, '.', ',')}}    </td>
                    ...
                    <tr>
                        ...
                        <td class="td_total_amount"> {{  number_format((  $total_hours) , 2, '.', ',')  }} <br> <br>  </td>
                        ...
                        <td class="td_total_amount">{{number_format(round($total_basic_unpaid_amnt,2) , 2, '.', ',')}}    </td>
                        <td class="td_total_amount">{{number_format(round($total_hourly_unpaid_amnt,2) , 2, '.', ',')}}    </td>
                        <td class="td_total_amount">{{number_format(round($total_basic_unpaid_amnt+$total_hourly_unpaid_amnt,2) , 2, '.', ',')}}   </td>
