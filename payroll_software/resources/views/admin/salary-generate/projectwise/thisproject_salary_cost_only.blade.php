...
<head>
    ...
    <title>Project Salary Cost Summary
    </title>
...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <br> <br>  <h3 style="text-align:center; color:red"> Project Salary Expese </h3> <br>
            ...
            <table id="employeeinfo">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td >{{$arecord['project_name']}}</td>
                        <td >{{$arecord['year']}}</td>
                        <td > {{$arecord['month_name']}}</td>
                        <td >{{$arecord['total_emp']}}</td>
                        <td >{{$arecord['total_overtime']}}</td>
                        <td >{{ $arecord['total_hour'] }}</td>
                        <td >{{ $arecord['total_hour'] + $arecord['total_overtime'] }}</td>
                        <td >{{round($arecord['total_salary'])}}</td>
