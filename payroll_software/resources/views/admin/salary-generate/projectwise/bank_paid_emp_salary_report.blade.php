    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p> <b> {{ $report_left_title[0] }}</b> <br> <b>Month:</b> {{ $report_left_title[1] }}-{{ $report_left_title[2] }}
                         <br>  <b>Project:</b> <br> {{ $report_left_title[3]== '-' ? 'All' : $report_left_title[3] }}
                  </p>
            </div>
            <!-- title -->
        ...
        <!-- table part -->
         ...
         <section class="table__part">
            <table >
                <thead>
                    <tr>
                        <th colspan = "13" style="text-align: center;" > {{ $report_left_title[1] }}, {{$report_left_title[2]}} </th>
                    </tr>
                    <tr>
                        <th>SL<br>No </th>
                        <th> Emp. <br> ID </th>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__sponser"><span class="sponser__name"> {{Str::limit( $salary->sponser->spons_name,12)}}</span> <br> {{ $salary->slh_total_hours }} </td>
                        ...
                        <td class="td__center"> <span class="employe__trade"> {{ Str::limit($salary->category->catg_name,10) }}</span> <br><br>
