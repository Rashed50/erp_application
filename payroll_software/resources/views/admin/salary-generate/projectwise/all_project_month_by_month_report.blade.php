...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <br>  <h5 style="text-align:left; color:red"> Salary Statement-{{ $my_list[0]['year'] }} </h5> <br>
                ...
                <thead>
                        ...
                        <th rowspan="2">Project</th>
                         @foreach($my_list as $my)
                            <th style="padding-top: 3px;"> {{ substr($my['month'],0,3) }} </th>
                        @endforeach
                        <th rowspan="2">Total</th>
                    </tr>
                     <tr>
                         @foreach($my_list as $my)
                            <th style="padding-top: 3px;">  {{ substr( $my['year'],2) }} </th>
                        @endforeach
                    </tr>
                </thead>
            <tbody>
                    ...
                    @php
                    $monthbase_total = array_fill(0,count($my_list),0);
                    $all_total_amount = 0;
                    @endphp
