    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p><strong class="td__red__color"> {{$reportLeftTitle[0]}} </strong> </p>
                <p> <strong>{{ $reportLeftTitle[1]}} </strong> </p>
                <p> <strong> {{$reportLeftTitle[2]}} </strong> </p>
            </div>
            <!-- title -->
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__sponser"><span class="sponser__name"> {{Str::limit( $salary->spons_name,15)}}</span> <br><br> {{ $salary->slh_total_hours }}/{{ $salary->slh_total_working_days }} </td>
                        ...
                        <td class="td__center"> <span class="employe__trade"> {{ Str::limit($salary->catg_name,10) }}</span> <br><br> {{round($salary->food_allowance) }}
                        ...
                        <!--<td class="td__gross_salary"><br><br> {{round( $salary->slh_total_salary + $salary->slh_cpf_contribution + $salary->slh_iqama_advance + $salary->slh_saudi_tax +$salary->slh_other_advance) }} </td>-->
                         <td class="td__gross_salary"><br><br>

                        {{round( $salary->slh_total_salary + $salary->slh_cpf_contribution + $salary->slh_iqama_advance + $salary->slh_saudi_tax +$salary->slh_other_advance + $salary->slh_food_deduction ) }}
                        </td>
                        ...
                        <td class="td__project"> {{ Str::limit($salary->proj_name,40) }}<br>
                    ...
                    <tr style="border:0; padding:0">
                        ...
                        <td> </td>
                        <td> </td>
                        <td class="td__project">{!! $multi_project !!}</td>
                    </tr>
                    ...
                    <tr style="border-bottom:0;">
                        ...
                        <td class="td__total">Total Salary <br> {{ $totalSalaryAmount + $totalSaudiTax + $totalIqamaRenewal +$totalOtherAdvance +$totalContribution + $totalFoodDeduction }}</td>
                        <td class="td__total">S.T+Adv+C.D<br>{{ $totalSaudiTax }}+ {{ $totalOtherAdvance }} <br> {{$totalFoodDeduction}}
                        </td>
                        <td class="td__total">Iqama Renew <br> {{ $totalIqamaRenewal}} </td>
