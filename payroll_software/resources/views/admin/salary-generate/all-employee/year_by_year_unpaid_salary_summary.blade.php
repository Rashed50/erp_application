            ...
            <table id="employeeinfo">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__sn">{{ $arecord->year }}</td>
                        @for ($month_id = 1; $month_id <= 12; $month_id++)

                            @if($summary->pluck('slh_month')->contains($month_id))
                                @php

                                    $emp = $summary[$counter]->total_unpaid ?? 0;
                                    $total_emp += $emp;
                                    $salary = $summary[$counter]->total_unpaid_salary ?? 0;
                                    $total_salary += $salary;
                                    $counter++;
                                ...
                                <td class="td_amount">
                                    {{ $emp }} <br> {{ number_format(round($salary) ,0, ',') }}
                                </td>
                                @else
                                <td class="td_amount">
                                    -
                             ...
                             @endif
                        @endfor
                        <td  class="td_amount">{{ $total_emp }} <br>{{ number_format(round($total_salary) , 0, ',')}}</td>
                    </tr>
                    @endforeach
                 </tbody>
            </table>
