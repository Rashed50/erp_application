    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="date__part">
                <p> Project : <strong class="td__red__color"> {{ $project }} </strong> </p>
                <p> Month: <strong class="td__red__color"> {{ $monthName }} </strong> </p>
                <p> Year: <strong class="td__red__color"> {{ $year}} </strong> </p>
            </div>
            <!-- title -->
        ...
        <!-- table part -->
        <br> <br>  <h3 style="text-align:center; color:red">Salary Paid on {{ $updated_date }} Summary Report</h3> <br>
            ...
            <table id="employeeinfo">
                <tbody>
                    ...
                    @php 
                     ...
                     $total_salary = 0;
                    @endphp
                    @foreach($salary_record as $salary)
                        @php 
                        $total_emp +=  $salary->total_emp; 
                        $total_salary += $salary->total_salary;                      
                        @endphp
                    <tr>
                        <td >{{$loop->iteration}}</td>                      
                        <td class="amount__td"> {{$salary->updated_by_name}}</td>
                    ...
                    <tr>
                        <td  class="total__td" colspan="2">Total</td>
                        <td class="total__td">{{$total_emp }}</td>                    
