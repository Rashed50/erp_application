    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="title_left__part">
                 <p> <strong>   <span class="startDate"> {!!nl2br($report_title)!!} </span></strong></p>
            </div>
            <!-- title -->
                ...
                <thead>
                    <tr>
                       <th> <span>S.N</span> </th>
                        ...
                        <th> <span>Working Project</span> </th>   
                        <th> <span>Remarks</span> </th>   
                        <th> <span>Adv.Paper</span> </th>
                    </tr>
                </thead>
                <tbody>
                    @php
                   ...
                   <tr>
                        ...
                        <td class="td__emplyoee_name"> <span>{{ $emp->inserted_by ?? '' }}</span> </td>
                        <td class="td__date"> <span>{{ $emp->date }} </span> </td>
                        <td class="td__date"> <span>{{$emp->created_at}} </span> </td>
                        <td class="td__amount"> <span>{{ $emp->adv_amount }}</span> </td>
                        <td class="td__emplyoee_name"> <span>{{ $emp->proj_name }}</span> </td>
                        <td class="td__emplyoee_name"> <span>{{ $emp->adv_remarks }}</span> </td>
                        <td class="td__amount"> <span>{{ $emp->advance_paper == null ? 'Not Found': 'Found' }}</span> </td>
                    </tr>
                    @endforeach
                    <tr>
