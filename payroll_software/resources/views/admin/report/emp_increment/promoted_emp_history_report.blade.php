            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> <span>Joining At</span> </th>
                        {{-- <th> <span>J.Salary</span> </th> --}}
                        <th> <span>J.Salary</span> </th>
                        <th> <span>Incr. Details</span> </th>
                        <th><span>Incr. Amnt</span></th>
                ...
                <tbody>
                    ...
                    <tr >
                        ...
                        <td class="td__project_title"> {{ Str::limit($emp->proj_name,20) }}</td>
                        <td class="td_common"> {{ $emp->joining_date }} </td>
                        <td class="td_common"> {{  round($emp->joining_salary)  }} </td>
                        ...
                        <td class="td_common">
                            ...
                            {{ $emp->hourly_employee == 1 ? $pr->hourly_rent:  $pr->total_amount}} SAR, {{ Str::substr($pr->month,0,3) }},{{ Str::substr($pr->year, 2, 2) }} <br>
                            @endforeach
