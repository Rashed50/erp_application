            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> <span>Cur.Salary</span> </th>
                        <th>Inc.Date</th>
                        <th> <span>Inc. Amnt</span> </th>
                ...
                <tbody>
                    ...
                    <tr >
                        ...
                        <td class="td_common">      {{ $emp->prom_date }}              </td>
                        <td class="td_common">      {{ $emp->increment_amount }}              </td>

                        {{-- <td class="td_common"> {{ $emp->prom_remarks }}  </td> --}}
                    </tr>
                    @endforeach
                </tbody>
                </tbody>
