            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <th> <span>Salary Received</span> </th>
                        <th> <span>Last Attendance</span> </th>
                        <th>Duration</th>
                ...
                <tbody>
                    ...
                    <tr >
                        ...
                        <td class="td_common"> {{ $emp->slh_salary_date }} </td>
                        <td class="td_common"> {{ $emp->last_attendance }}   </td>
                        <td class="td_common">{{ $activity_period }} Months</td>
