        ...
        <section class="table__part">
            ...
            <table>
                ...
                <tr >
                  ...
                  <td class="td__country"> {{ Str::limit($emp->country->country_name,6) }}</td>
                  <td class="td__emplyoee_info"> {{ $emp->project->proj_name == null ? "Not Assign" : Str::limit( $emp->project->proj_name,15)}} </td>
                  <td class="td__emp_trade"> {{ Str::limit($emp->category->catg_name,13) }} </td>
                  <td class="td__emplyoee_info"> {{ Str::limit( $emp->sponser->spons_name,12) }}</td>
                  <td> <span>{{  $emp->akama_expire_date }}</span> </td>
