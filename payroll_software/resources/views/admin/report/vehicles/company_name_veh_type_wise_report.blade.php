    ...
    <div class="main__wrap">
        ...
        <section class="header__part">
            ...
            <div class="title_left__part">
                <p> <strong>  Company Vehicles List</strong></p>
            </div>
            <!-- title -->
            ...
            <table>
                <thead>
                    <tr>
                        ...
                        <!--<th> <span>Reg. Expire</span> </th>-->
                        <th class="download_link"> <span>Iqama Cert</span> </th>

                    </tr>
                </thead>
                <tbody>
                    @foreach ($vehicleRecords as $vehicle)
                        ...
                        <td class="td__info_center">{{ $vehicle->dri_iqama_no }}</td>
                        ...
                        <td class="td__info_center">
                            <a target="_blank" class="download_link" href="{{URL::to($vehicle->dri_iqama_certificate) }}"  class="btn btn-danger">Drv.Iqama</a>||
                        
                            <a target="_blank" class="download_link" href="{{URL::to($vehicle->dri_license_certificate) }}"  class="btn btn-danger">Driv.License</a>||
                         
                            <a target="_blank" class="download_link" href="{{URL::to($vehicle->veh_reg_certificate) }}"  class="btn btn-danger">Veh.Reg.</a> </td>
                        </tr>
                    @endforeach
              </tbody>
            </table>
