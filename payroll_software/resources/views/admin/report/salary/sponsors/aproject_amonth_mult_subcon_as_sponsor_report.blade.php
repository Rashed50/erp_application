...
<head>
    ...
    <title> Subcon Salary-Summary</title>
    <!-- style -->
    <style>
        .loader {
...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <br>  <h3 style="text-align:center; color:black">Subcontractors Monthly Salary Summary </h3> <br>
        <section class="table__part">
            ...
            <tbody>
                    ...
                    @php
                      ...
                      $ground_total_hours += $ar->total_hour + $ar->total_overtime;
                    ...
                    <tr>
                        ...
                        <td class="td__project">{{$ar->spons_name }}</td>
                        <td class="td__total">{{$ar->total_emp }}</td>
                        <td class="td__total">{{  $ar->total_hour + $ar->total_overtime }}</td>
                        <td class="td__total">{{ $ar->total_salary   }}</td> {{-- food amount is included with total salary --}}
                        <td class="td__total">  </td>
                    </tr>
                    @endforeach
                    <tr class="tr__ground_total">
                        <td class="td__total" colspan="2"> Total  </td>
                        <td class="td__total"> {{  $project_total_workers  }} </td>
                        <td class="td__total"> {{ $ground_total_hours   }} </td>
                        <td class="td__total"> {{  $project_total_amount   }} </td>
                        <td class="td__total">  </td>
                    </tr>
                </tbody>
            </table>
