...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <br>  <h3 style="text-align:center; color:black"> Multiple Sponsors Monthly Salary Summary As Per Salary Sheet </h3> <br>
        <section class="table__part">
            ...
            <tbody>
                    <tr class="tr__header">
                        ...
                        <td colspan="2"> {{  $sp->spons_name  }}  </td>
                        @endforeach
                        <td rowspan="2">Total Workers</td>
                    ...
                    <tr>
                        ...
                        $project_total_hours +=  $ar->total_hours;
                        $grand_total_hours +=  $ar->total_hours;

                        $sponsors_base_total_amount[$counter++] += $ar->total_gross_salary;

                        @endphp
                            <td class="td__amount">{{  $ar->total_emp == 0 ? "-" :  $ar->total_emp}}  <br>  {{ $ar->total_hours <= 0 ? '-': number_format( $ar->total_hours , 0, '.', ',') }} </td>
                            <td class="td__amount"> <br>  {{ $ar->total_gross_salary <= 0 ? '-': number_format( $ar->total_gross_salary , 0, '.', ',') }} </td>
                        @endforeach
                    ...
                    <tr class="tr__ground_total">
                        ...
                        @endforeach
                        <td style="text-align: center">{{ $grand_total_emp }}</td>
                        <td>{{ $grand_total_hours <= 0 ? '-':  number_format( $grand_total_hours , 0, '.', ',') }}  </td>
