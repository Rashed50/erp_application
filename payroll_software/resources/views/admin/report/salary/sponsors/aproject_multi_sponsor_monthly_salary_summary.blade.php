...
<body>
    ...
    <div class="main__wrap">
        ...
        <!-- table part -->
        <br>  <h3 style="text-align:center; color:red"> Single Project and Multiple Sponsor Monthly Salary Summary </h3> <br>
        <section class="table__part">
            ...
            <tbody>
                    <tr>
                        <th>S.N</th>
                        <th>Sponsor Name </th>
                        <th>Total Running Workers</th>
                        @foreach($months as $my)
                        @php
                            $month_name = date("F", mktime(0, 0, 0, $my, 10));
                        @endphp
                    ...
                    <tr>
                        ...
                        <td class="td__sn"> {{ $ar->total_employee }}</td>
                        @foreach($records as $ar)
                        @php
                        $project_total_amount += $ar->total_gross_salary;
                        @endphp

                            <td class="td__amount">{{ $ar->total_gross_salary <= 0 ? '-': number_format( $ar->total_gross_salary , 0, '.', ',') }} </td>
