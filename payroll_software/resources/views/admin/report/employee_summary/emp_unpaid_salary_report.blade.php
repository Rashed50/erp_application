    ...
    <div class="main__wrap">
        ...
        <section class="table__part">
            <table id="salary_table">
                <thead>
                    <tr>
                        <td colspan="13" style="text-align: center;background:#B3E6FA;padding-top:5px;padding-bottom:5px;font-size: 12px;font-weight: bold;">
                           Unpaid Salary of   ID {{ $employee->employee_id}}, {{$employee->employee_name}}
                        </td>
                    </tr>
                    <tr style="">
                        <th>S.N </td>
