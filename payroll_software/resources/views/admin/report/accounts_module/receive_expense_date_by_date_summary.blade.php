...
<body>
    ...
    <div class="main__wrap">
        ...
        <br>
        <h4 style="text-align: center;padding-bottom:10px"> Cash Received & Expense Summary From {{$from_date}} To  {{$to_date}}</h4>
        ...
        <section class="table__part">
            <table id="employeeinfo">
                ...
                <tbody>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="7" class="td__gross_salary"> Total Received </td>
            ...
            <table id="employeeinfo">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__gross_salary"> {{ number_format(($total_cr_amount - $total_dr_amount),2) }}</td>
                    </tr>
