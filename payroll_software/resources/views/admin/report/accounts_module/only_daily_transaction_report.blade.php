            ...
            <table id="employeeinfo">
                <thead>
                     ...
                     <tr>
                        ...
                        <th class="th__header">Bank Name</th>
                        <th class="th__header">Description</th>
                        <th class="th__header">Rec. Type</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__emp_name"> {{ $ar->bank_name }} </td>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="7" class="td__gross_salary"> Total </td>
                        <td class="td__gross_salary"> {{ number_format($total_received_amount,2)}} </td>
                    </tr>
                </tbody>
            </table>
        </section>
            ...
            <table id="employeeinfo">
                <thead>
                     <tr>
                        ...
                        <th class="th__header">Pay Type</th>
                        <th class="th__header">Inserted By</th>
                        <th class="th__header">Amount</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__gross_salary"> {{ number_format(($total_received_amount - $total_expense_amount),2) }}</td>
                    </tr>
                </tbody>
            </table>
        </section>
