...
<body>
    ...
    <div class="main__wrap">
        ...
        <br>
        <h5 style="text-align: center; padding-bottom:10px;">Expense base Summary Report From {{$from_date}}  To {{$to_date}} </h5>
            ...
            <table id="employeeinfo">
                ...
                <tbody>
                    ...
                    @php 
                        ...
                        $month_name = App\Http\Controllers\Admin\Helper\HelperController::getMonthNameByStaticMethod($ar->month_id);
                    @endphp

                    <tr>
                        <td class="td__sn">{{ $loop->iteration }}</td>
                        <td class="td__expense_head"> {{ $ar->cost_type_name  }} </td>
                        <td class="td__date"> {{ $month_name}}, {{ $ar->year }} </td>
                        <td class="td__date"> {{ $ar->year }} </td> 
