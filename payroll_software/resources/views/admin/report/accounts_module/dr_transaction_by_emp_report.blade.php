...
<body>
    ...
    <div class="main__wrap">
        ...
        <br>
        <h5 style="text-align: center; padding-bottom:10px;"> Employee Base Expense Report From {{$from_date}}  To {{$to_date}} </h5>
            ...
            <table id="employeeinfo">
                <thead>
                     <tr>
                        ...
                        <th class="th__header">Payment <br>Type</th>
                         <th class="th__header">Project</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="td__project"> {{ $ar->proj_name == null ? '-' : Str::limit($ar->proj_name,50) }}  </td>
                        <td class="td__date"> {{ $ar->ExpenseDate }} </td>
                        <td class="td__remarks"> {{ $ar->Remarks != null ? $ar->Remarks : '-'  }}</td>
                        <td class="td__inserted_by">{{ $ar->name  }} </td>
                    ...
                    @endforeach
                    <tr>
                        <td colspan="9" class="td__gross_salary"> Total = </td>
