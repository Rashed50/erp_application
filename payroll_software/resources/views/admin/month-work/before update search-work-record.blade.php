...
<div class="row bread_part">
    <div class="col-sm-12 bread_col">
        <h4 class="pull-left page-title bread_title"> Searching Employee Work(Multi Project) Records</h4>
        <ol class="breadcrumb pull-right">
            <li><a href="{{ route('admin.dashboard') }}">Dashboard</a></li>
            <li class="active">Working Records</li>
        </ol>
    </div>
</div>
...
<!-- monthly mutiproject record list -->
<div class="row">
    <div class="col-12">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group row custom_form_group">
                    ...
                    <div class="col-sm-4">
                        <input type="date" class="form-control"   name="new_record_startDate"
                            value="{{ date('Y-m-d') }}" max="{{ date('Y-m-d') }}" required>
                            
                     </div>
                     <label class="col-sm-1 control-label">To:</label>
                     <div class="col-sm-5">
                         <input type="date" class="form-control" max="{{ date('Y-m-d') }}" name="new_record_endDate"
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        // Employee ID Field Enter Key Press
