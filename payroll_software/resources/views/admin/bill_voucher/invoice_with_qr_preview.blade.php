...
<body>
    ...
    <div class="grid-container" id="printable-area">
        ...
        <table id="invoice_table" width="100%" style="padding: 0px 0px 0px 0px; font-size:10px;">
            ...
            <tr>
                <td  >{{$counter++}}</td>
                <td  >{{$invRecord->area_no }}</td>
                <td  >{{$invRecord->item_no }}</td>
                <td  >{{ $invRecord->items_details }}</td>
                {{-- <td class="table-border">Ref No.</td> --}}
                <td  >{{ $invRecord->item_unit }}</td>
                <td  >{{$invRecord->quantity }}</td>
                <td  >{{$invRecord->rate }}</td>
            ...
            <tr>
                <td colspan="8" class="table-border single-paddingTwo">
                        ...
                        $inword = $f->format($invoiceRecord->total_amount  -  $invoiceRecord->total_retention );
                        @endphp
                        {{$inword}}
                    </p>   --}}
                </td>
                ...
                <table>
                    <tr >
                        <td colspan="5" class="single-padding-three" text-align="left">
                            <strong  style="float: left;">Please Pay To</strong ></td>
                    </tr>
                    <tr>
