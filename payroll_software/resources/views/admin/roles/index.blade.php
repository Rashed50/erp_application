          ...
          <div class="card-header">
                <div class="row">
                  ...
                  <div class="col-md-6 text-right">
                     @can('role-create')
                        <a href="{{ route('roles.create') }}" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle mr-2"></i>New Role </a>
                        <a data-toggle="modal" data-target="#loginModal" class="btn btn-md btn-primary waves-effect card_top_button"><i class="fa fa-plus-circle mr-2"></i>New Permission</a>
                    @endcan
                  </div>
