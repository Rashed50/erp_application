...
class UpdateCustomerRequest extends FormRequest
{
     ...
     *
     * Authorization is enforced by the `permission:customers.update` middleware
     * on the route.
     */
     ...
     *
     * Note: `opening_balance` is intentionally not editable here. It is fixed at
     * creation time and only `current_balance` moves afterwards, via ledger
     * transactions, so that the running balance stays reconcilable.
     *
